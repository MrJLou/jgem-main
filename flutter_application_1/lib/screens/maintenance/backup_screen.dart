...
class _BackupScreenState extends State<BackupScreen> {
  ...
  Future<void> _initializeBackupSettings() async {
    // BACKUP LOCATION
    _backupLocation = (await getApplicationDocumentsDirectory()).path + '/backups';
    _lastBackupDate = _backupHistory.isNotEmpty ? _backupHistory.first['date'] : null;
  }
                                  ...
                                  DataCell(
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        IconButton(
                                          icon: Icon(Icons.download, color: Colors.teal[700]),
